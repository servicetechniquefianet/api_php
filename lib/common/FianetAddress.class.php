 ...
 */
class FianetAddress extends FianetXMLElement {
  ...
  /**
   * creates an object FianetXMLElement representing the element <appartement>, child of <adresse>, adds it to the current object then returns it
   * 
