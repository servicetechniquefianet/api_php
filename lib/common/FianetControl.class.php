...
class FianetControl extends FianetDOMDocument
{
	...
	/**
	 * creates an object FianetCustomer representing the element <utilisateur> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type
	...
	{
		$customer = $this->root->appendChild(new FianetCustomer());
		if ($type != '')
		{
			$customer->addAttribute('type', $type);
			$customer->addAttribute('qualite', FianetCustomer::TYPE_PARTICULIER);
		}
	...
	/**
	 * creates an object FianetCustomer representing the element <utilisateur type='facturation'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type
	 * @param string $civility
	 * @param string $lastname
	...
	/**
	 * creates an object FianetCustomer representing the element <utilisateur type='livraison'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type
	 * @param string $civility
	 * @param string $lastname
	...
	/**
	 * creates an object FianetCustomer representing the element <adresse> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	...
	/**
	 * creates an object FianetCustomer representing the element <adresse type='facturation'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type has to be 'livraison' or 'facturation'
	 * @param string $street main street of the address
	 * @param string $zipcode
	...
	/**
	 * creates an object FianetCustomer representing the element <adresse type='livraison'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type has to be 'livraison' or 'facturation'
	 * @param string $street main street of the address
	 * @param string $zipcode
	...
	/**
	 * creates an object FianetOrderDetails representing the element <infocommande> then adds it as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 ...
	 * @return FianetOrderDetails
	 */
	public function createOrderDetails($refid, $siteid, $amount, $currency, $ip, $timestamp)
	{
		$order_details = $this->root->appendChild(new FianetOrderDetails());
	...
	/**
	 * creates an object FianetXMLElement representing the element <paiement> then adds it as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	...
	{
		$payment = $this->root->appendChild(new FianetXMLElement('paiement'));
