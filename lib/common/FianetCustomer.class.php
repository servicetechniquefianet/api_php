 ...
 */
class FianetCustomer extends FianetXMLElement
{
	...
	/**
	 * creates an object FianetXMLElement reprensenting <siteconso>, adds it to the current object and sets its children, then returns it
	 * 
