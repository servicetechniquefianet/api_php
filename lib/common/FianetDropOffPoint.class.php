 ...
 */
class FianetDropOffPoint extends FianetXMLElement {
  ...
  /**
   * creates an object FianetXMLElement representing the element <adresse> and adds it as a child of the current element, then returns it
   * 
