...
class FianetXMLElement extends DOMElement
{
	...
	/**
	 * creates an FianetXMLElement then adds as a child then returns the child
	 * 
	 * @param string $name
	 * @param string $value
	...
	{
		$child = $this->appendChild(new FianetXMLElement($name));
